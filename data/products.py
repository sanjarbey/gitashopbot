...
ds_praktikum = Product(
    ...
    photo_url='https://dastur.uz/wp-content/uploads/2023/04/0604-768x768.jpg',
    photo_width=1280,
    photo_height=564,
    # photo_size=600,
    need_email=True,
...
shoploti = Product(
    title="Shoptoli oliy nav",
    description="Shoptoliga to'lov qilish uchun quyidagi tugmani bosing.",
    currency="USD",
    prices=[
        LabeledPrice(
            label='Kitob',
    ...
    start_parameter="create_invoice_shoptoli",
    photo_url='https://pbs.twimg.com/media/DumLTKMWsAAstYr.jpg',
    photo_width=851,
    photo_height=1280,
    # photo_size=800,
    need_name=True,
